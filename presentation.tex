  ...
  \begin{definition}[Typing rules for $\LamM$-terms]
    ...
    \[
      \begin{prooftree}
        ...
        \only<1>{ \hypo{ \Gamma ; B \vdash l : C } }
        \only<2>{ \hypo{ \color{blue} \Gamma ; B \vdash l : C } }
        \only<1>{ \infer3[mElim]{ \Gamma \vdash t(u, l) : C } }
        \only<2>{ \infer3[\color{red}mElim]{ \Gamma \vdash t(u, l) : C } }
      \end{prooftree}
    \]
    \[
      \begin{prooftree}
  ...
  \onslide<2->{
    ...
    \[
      \begin{prooftree}
        ...
        \infer3[\color{red}gElim]{ \Gamma \vdash C }
      \end{prooftree}
    \]
  }
\end{frame}
  ...
  \[\scriptsize
    ...
    \[\scriptsize
      \begin{prooftree}
        ...
        \infer2[dashed,Cut*]{ \Gamma ; B \vdash l+(u'::l') : E }
        \infer3[mElim]{ \Gamma \vdash t(u, l+(u'::l')) : E }
      \end{prooftree}
    \]
\end{frame}
