...
\begin{frame}
	...
	\begin{itemize}
		\item<6-> Computational interest: results from a simple adaptation of applicative terms $t u \to t(u, l)$
		\item<7-> Logical interest: typing rules exhibit a sequent calculus flavour
	\end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{The commuting conversion behind $h$}
  \[\scriptsize
    \begin{prooftree}
        \hypo{ \Gamma \vdash t : A \supset B }
        \hypo{ \Gamma \vdash u : A }
    ...
    \[\scriptsize
      \begin{prooftree}
        ...
        \infer2[Cut*]{ \Gamma ; B \vdash l+(u'::l') : E }
        \infer3[mElim]{ \Gamma \vdash t(u, l+(u'::l')) : E }
      \end{prooftree}
    \]
\end{frame}
...
\begin{frame}
  \frametitle{A commuting conversion}
  \[\small
    \begin{prooftree}
        \hypo{ \Gamma \vdash A \supset B }
        \hypo{ \Gamma \vdash A }
        \hypo{ \Gamma ; B \vdash C \supset D }	
        \infer3[mElim]{ \Gamma \vdash C \supset D }
        \hypo{ \Gamma \vdash C }
        \hypo{ \Gamma ; D \vdash E }
        \infer3[mElim]{ \Gamma \vdash E }
      \end{prooftree}
    \]
    \[ \rightsquigarrow \]
    \[\small
      \begin{prooftree}
        ...
        \hypo{ \Gamma \vdash C }
        \hypo{ \Gamma ; D \vdash E }
        \infer2[Left*]{ \Gamma ; C \supset D \vdash E }
        \infer2[Cut*]{ \Gamma ; B \vdash E }
        \infer3[mElim]{ \Gamma \vdash E }
      \end{prooftree}
    \]
\end{frame}
