...
Furthermore, formalising a system using a proof assistant enhaces reusability of such formalisation.
...
This includes the result of subject reduction, the theorem of conservativeness, an isomorphism of its subsystem with the simply typed $\Lam$-calculus and confluence results derived from $\Lam$-calculus.
