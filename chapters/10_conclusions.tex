...
Second, in the case of system $\LamV$, we would have nothing generated by \textit{Autosubst2}, as this system has an unexpected behaviour because of its non conventional substitution operation.
...
An example of this could be a refinement of the library to deal with relaxed versions of the $\sigma$-calculus, this is, syntaxes that do not satisfy every substitution lemma.
