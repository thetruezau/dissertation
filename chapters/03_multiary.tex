...
So far, our aproach on the formalisation of the canonical subsystem of $\LamM$ was to view it according to map $h$, that is, defining reduction and typification using this map.
