...
\begin{proof}
  ...
  \[ \begin{prooftree}      
      ...
      \infer[dashed,left label=\text{*\cref{canonical_typing}}]1{ \Gamma \vdash t_0:A }
      \infer[dashed]0[\text{\cref{h_is_multistep}}]{ t_0 \twoheadrightarrow_{h} h(t_0) }
      \infer[dashed]1[\twoheadrightarrow_{h} \subset \twoheadrightarrow_{\beta h}]{ t_0 \twoheadrightarrow_{\beta h} h(t_0) }
      \infer[dashed,left label=\text{\cref{type_preservation2}}]2{ \Gamma \vdash i(t):A }
      \hypo{ t \to_{\beta} t' }
      \infer[dashed]1[\text{\cref{conservativeness}}]{ i(t) \twoheadrightarrow_{\beta h} i(t') }
      \infer[dashed]2[\text{\cref{type_preservation2}}]{ \Gamma \vdash i(t'):A }
