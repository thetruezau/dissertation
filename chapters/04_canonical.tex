...
\begin{corollary}[Isomorphism of reduction] \hfill
  ...
  \begin{enumerate}
  \item $t \to_{\beta} t'$ in $\LamV$ $\iff$ $i(t) \ ({\to_{\beta}})_c \ i(t')$ in $Can$
  \item $t \ ({\to_{\beta}})_c \ t'$ in $Can$ $\iff$ $p(t) \to_{\beta} p(t')$ in $\LamV$
  \end{enumerate}
\end{corollary}
\begin{proof}
...
\begin{corollary}[Confluence lift]
  If $\twoheadrightarrow_\beta$ is confluent in $\LamV$, then $\twoheadrightarrow_{\beta h}$ is confluent in $\LamM$. 
\end{corollary}
\begin{proof}
  ...
  \[
    ...
    \begin{tikzcd}
      & p(t) \arrow[dd, dashed, "\beta"] \arrow[ld, two heads, "\beta"] \arrow[rd, two heads, "\beta"] & \\
      p(t_1) \arrow[rd, two heads, "\beta"] && p(t_2) \arrow[ld, two heads, "\beta"] \\
      & \exists \ t' &                             
    \end{tikzcd}
  \]
\end{proof}
