...
As a small display of the versatility of this options, in the \lst$Intro$ rule, one can find context \lst$(A.:Gamma)$.
...
We do this by proving the preservation of renamings (also an idea from~\cite{AutosubstManual}), as every structural rule involves a renaming of the nameless $\Lam$-term.
